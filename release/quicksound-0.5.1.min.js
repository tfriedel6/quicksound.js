...
c.currentSourceNode=null)}function v(c){function a(){var a=document.getElementById("audioSWF");null==a&&(a=document.createElement("span"),document.body.appendChild(a));a.innerHTML='<object id="audioSWF1" width="1" height="1"><param name="movie" value="quicksound-0.5.1.swf"><embed id="audioSWF2" src="quicksound-0.5.1.swf" width="1" height="1"></embed></object>'}function b(d){0<d?setTimeout(function(){var a=document.getElementById("audioSWF1");a&&a.isAvailable&&a.isAvailable()?c(a):(a=document.getElementById("audioSWF2"))&&
a.isAvailable&&a.isAvailable()?c(a):b(d-1)},100):(document.getElementById("audioSWF").removeChild(document.getElementById("audioSWF1")),0<e--?(a(),b(6)):c(null))}a();var e=4;b(6)}function w(c){for(var a=0;a<c.length;a++)if(-1!=c[a].toLowerCase().indexOf("mp3"))return c[a];return null}function x(c,a,b){return function(){function e(){function h(a){0<a?setTimeout(function(){c.isLoaded(k)?b.doneFunc(b,k):c.isError(k)?b.errorFunc(b):h(a-1)},50):d++<b.retries?setTimeout(function(){e()},1E3):b.errorFunc(b)}
var k=c.loadSound(a);h(200)}var d=0;e()}}quicksound.create=function(c,a){var b=null;try{b=new AudioContext}catch(e){try{b=new webkitAudioContext}catch(d){}}null!=b?(quicksound.bestFormat=r,quicksound.load=function(a){return p(b,a,t)},quicksound.play=function(a,c,d){var e=b;if(e){var f=e.createBufferSource();f.buffer=a;f.connect(e.destination);f.loop=d;f.start?f.start(0,c):f.noteOn&&!c&&f.noteOn(0);a.currentSourceNode=f;a.startTime=y()}},quicksound.stop=u,setTimeout(c,1)):v(function(b){null!=b?(quicksound.bestFormat=
w,quicksound.load=function(a){return p(b,a,x)},quicksound.play=function(a,c,d){b&&b.playSound(a,c,d)},quicksound.stop=function(a){b.stopSound(a)},c()):a()})};var s=Array.isArray?Array.isArray:function(c){return"[object Array]"===Object.prototype.toString.call(c)},y=Date.now?Date.now:function(){return(new Date).valueOf()}})();
