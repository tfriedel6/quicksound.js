...
c.currentSourceNode=null)}function v(c){function a(){var a=document.getElementById("audioSWF");null==a&&(a=document.createElement("span"),document.body.appendChild(a));a.innerHTML='<object id="audioSWF1" width="1" height="1"><param name="movie" value="quicksound-0.5.swf"><embed id="audioSWF2" src="quicksound-0.5.swf" width="1" height="1"></embed></object>'}function b(d){0<d?setTimeout(function(){var a=document.getElementById("audioSWF1");a&&a.isAvailable&&a.isAvailable()?c(a):(a=document.getElementById("audioSWF2"))&&
