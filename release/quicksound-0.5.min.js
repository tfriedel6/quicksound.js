...
c.currentSourceNode=null)}function u(c){function a(){document.getElementById("audioSWF").innerHTML='<object id="audioSWF1" width="1" height="1"><param name="movie" value="quicksound.swf"><embed id="audioSWF2" src="quicksound.swf" width="1" height="1"></embed></object>'}function b(d){0<d?setTimeout(function(){var a=document.getElementById("audioSWF1");a&&a.isAvailable&&a.isAvailable()?c(a):(a=document.getElementById("audioSWF2"))&&a.isAvailable&&a.isAvailable()?c(a):b(d-1)},100):(document.getElementById("audioSWF").removeChild(document.getElementById("audioSWF1")),
0<e--?(a(),b(6)):c(null))}a();var e=4;b(6)}function v(c){for(var a=0;a<c.length;a++)if(-1!=c[a].toLowerCase().indexOf("mp3"))return c[a];return null}function w(c,a,b){return function(){function e(){function f(a){0<a?setTimeout(function(){c.isLoaded(k)?b.doneFunc(b,k):c.isError(k)?b.errorFunc(b):f(a-1)},50):d++<b.retries?setTimeout(function(){e()},1E3):b.errorFunc(b)}var k=c.loadSound(a);f(200)}var d=0;e()}}quicksound.create=function(c,a){var b=null;try{b=new AudioContext}catch(e){try{b=new webkitAudioContext}catch(d){}}null!=
b?(quicksound.bestFormat=p,quicksound.load=function(a){return l(b,a,s)},quicksound.play=function(a,c,d){var e=b;if(e){var h=e.createBufferSource();h.buffer=a;h.connect(e.destination);h.loop=d;h.start?h.start(0,c):h.noteOn&&!c&&h.noteOn(0);a.currentSourceNode=h;a.startTime=x()}},quicksound.stop=t,setTimeout(c,1)):u(function(b){null!=b?(quicksound.bestFormat=v,quicksound.load=function(a){return l(b,a,w)},quicksound.play=function(a,c,d){b&&b.playSound(a,c,d)},quicksound.stop=function(a){delete a.resumePosition;
b.stopSound(a.audioBuffer)},c()):a()})};var r=Array.isArray?Array.isArray:function(c){return"[object Array]"===Object.prototype.toString.call(c)},x=Date.now?Date.now:function(){return(new Date).valueOf()}})();
